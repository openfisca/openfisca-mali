...
Les évolutions d'OpenFisca-Mali doivent pouvoir être comprises par des réutilisateurs qui n'interviennent pas nécessairement sur le code. Le Changelog, rédigé en français, se doit donc d'être le plus explicite possible.
...
> Par exemple :
> # 13.0.0 - [#671](https://github.com/openfisca/openfisca-mali/pull/671)
>
> ## 13.2.0 - [#676](https://github.com/openfisca/openfisca-mali/pull/676)
>
> ### 13.1.5 - [#684](https://github.com/openfisca/openfisca-mali/pull/684)
...
>
> * Détails :
>   - Déplacement du test runner depuis `mali` vers `core`.
...
Certaines interventions sur OpenFica concernent à la fois [OpenFica-Core](https://github.com/openfisca/openfisca-core) et OpenFisca-Mali.

C'est par exemple le cas lorsqu'une version à paraître de Core contient un changement non-rétrocompatible, et que l'on souhaite s'assurer qu'il est possible d'adapter Mali à cette nouvelle version.

Dans ce cas, il peut être pertinent de faire tourner les tests d'OpenFisca-Mali en se basant sur une version non-publiée de Core, disponible sur une branche spécifique. Pour ce faire, éditer le fichier `circle.yml` comme suit :
...
Bien sûr, une fois la version spécifique de core publiée, **ce changement doit être reverté** avant le merge de la pull request sur Mali.
